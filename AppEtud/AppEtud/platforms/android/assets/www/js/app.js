...
// 'app' is the name of this angular module example (also set in a <body> attribute in index.html)
 ...
 .run(function($ionicPlatform, $cordovaDevice,$cordovaSQLite) {
     $ionicPlatform.ready(function() {
         ...
         $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS etudiant (mat integer  primary key, nom text, prenom text, dateNaissance date, site text)");
     });
 });
